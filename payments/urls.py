...
urlpatterns = [
    ...
    path("<int:pk>/closing/<int:step_id>/update/", views.PaymentClosingStepUpdateView.as_view(), name="update_closing_step"),
    path("<int:pk>/closing/<int:step_id>/stk-push/", views.PaymentClosingStepStkPushView.as_view(), name="closing_step_stk_push"),
