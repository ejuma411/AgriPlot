...
class SMSServiceTestCase(TestCase):
    ...
    def test_send_sms_success(self, mock_post):
        ...
        self.assertEqual(result['data']['SMSMessageData']['Message'], 'Sent to 1 recipients')
    ...
    def test_send_otp(self, mock_post):
        ...
        mock_response = MagicMock()
        mock_response.status_code = 201
        mock_response.json.return_value = {'SMSMessageData': {'Message': 'OTP sent'}}
        mock_post.return_value = mock_response
